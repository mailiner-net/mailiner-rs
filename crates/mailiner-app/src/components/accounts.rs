...
/// `/settings/accounts/new` — same wizard / CommitNewAccount as onboarding.
#[component]
pub fn AccountNewPage() -> Element {
    rsx! {
        crate::components::account_setup::AccountSetupWizard {
            mode: crate::setup_wizard::SetupMode::AddAccount,
        }
    }
}
